...
import { ApplicationsManager } from './packages/boilerPlates/applications/ApplicationsManager';
import { ArtifactsManager } from './artifacts/ArtifactsManager';
import { BoilerplatesManager } from './packages/boilerplates/Source/BoilerPlatesManager';
import { BoundedContextsManager } from './packages/boilerPlates/boundedContexts/BoundedContextsManager';
import { ConfigManager } from './packages/configurations/ConfigManager';
import { ConfigParser } from './packages/configurations/ConfigParser';
import { DependenciesManager } from './packages/dependencies/DependenciesManager';
import { Folders } from './packages/utilities/Folders';
import { HttpWrapper } from './HttpWrapper';
import { Guid } from './packages/utilities/Guid';
import { ProjectConfig } from './packages/configurations/ProjectConfig';
import { BoilerplatesConfig } from './packages/configurations/BoilerplatesConfig';
...
export function getManagers() {
    if (!isInitialized) {
        ...
        boundedContextsManager = new BoundedContextsManager(boilerplatesManager, applicationsManager, folders, filesystem, logger);
...
export const helpers = require('./packages/utilities/helpers');
