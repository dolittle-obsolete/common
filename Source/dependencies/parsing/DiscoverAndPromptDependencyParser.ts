...
*--------------------------------------------------------------------------------------------*/
import { ICanParseDependencies, discoverDependencyType, IDiscoverDependency, DiscoverAndPromptDependency, IPromptDependency, CannotParseDependency } from '../internal';
