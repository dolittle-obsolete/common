...
describe('and there is a non valid dependency', () => {
    let exception: Error;
    const a_valid_dependency = new DiscoverDependency('valid dependency', 'desc', [], namespaceDiscoverType,  undefined, 'some milestone');
    const an_invalid_dependency =  new DiscoverDependency('name', 'desc', [], 'invalid discover type');
    const dependencies = [
       a_valid_dependency,
