 ...
 * @returns
 */
export async function fetchDolittleBoilerplates(onlineBoilerplatesDiscoverer: ICanFindOnlineBoilerplatePackages, onStdOut?: OnStdCallback, onStdErr?: OnStdCallback ) {
