...
export abstract class Namespace implements INamespace {
     ...
     */
    constructor(private _includeDefault: boolean, private _name: string, private _commands: ICommand[], private _commandGroups: ICommandGroup[],
        private _description: string, private _shortDescription: string = _description) {}
    
    get includeDefault() { return this._includeDefault; }
